    ...
    <main className="auth-page">
      <section className="auth-promo">
        ...
        <div>
          ...
          <p>
            Thoughtful courses and inspiring teachers, all in one calm place for
            your family.
          </p>
        </div>
        <small>© 2025 Learniee</small>
      </section>
      <section className="auth-form-wrap">
        <form className="auth-form" onSubmit={submit}>
          <div>
            <p className="eyebrow">
              WELCOME {isSignup ? "TO LEARNIEE" : "BACK"}
            </p>
            <h2>
              {isSignup
            ...
            <p>
              {isSignup
                ? "Start finding courses your child will love."
          ...
          <p className="auth-switch">
            {isSignup ? "Already have an account?" : "New to Learniee?"}{" "}
